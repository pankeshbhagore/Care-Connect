...
async function seed() {
  ...
  // 4. Apply Gov Registration + Trust Scores
  const govPatches = {
    "HOSP-0001":{ tier:"Tier1", trustScore:82, acceptanceRate:95, govRegistration:{ayushmanEmpanelled:true,nhm:true,emergencyService:true,moh:false,registrationCode:"GOV-JBP-001"} },
    "HOSP-0002":{ tier:"Tier1", trustScore:88, acceptanceRate:97, govRegistration:{ayushmanEmpanelled:true,nhm:true,emergencyService:true,moh:true,registrationCode:"GOV-JBP-002"} },
    "HOSP-0003":{ tier:"Tier2", trustScore:76, acceptanceRate:88, govRegistration:{ayushmanEmpanelled:true,nhm:false,emergencyService:false,moh:false,registrationCode:"PVT-JBP-001"} },
    "HOSP-0004":{ tier:"Tier1", trustScore:65, acceptanceRate:80, govRegistration:{ayushmanEmpanelled:true,nhm:true,emergencyService:true,moh:false,registrationCode:"GOV-KTN-001"} },
    "HOSP-0005":{ tier:"Tier2", trustScore:79, acceptanceRate:91, govRegistration:{ayushmanEmpanelled:true,nhm:false,emergencyService:false,moh:false,registrationCode:"PVT-JBP-002"} },
    "HOSP-0006":{ tier:"Tier1", trustScore:70, acceptanceRate:85, govRegistration:{ayushmanEmpanelled:true,nhm:true,emergencyService:true,moh:false,registrationCode:"GOV-NRS-001"} },
    "HOSP-0007":{ tier:"Tier2", trustScore:84, acceptanceRate:93, govRegistration:{ayushmanEmpanelled:true,nhm:false,emergencyService:true,moh:false,registrationCode:"PVT-SGR-001"} },
    "HOSP-0008":{ tier:"Tier1", trustScore:80, acceptanceRate:92, govRegistration:{ayushmanEmpanelled:true,nhm:true,emergencyService:true,moh:true,registrationCode:"GOV-SGR-002"} },
    "HOSP-0009":{ tier:"Tier1", trustScore:72, acceptanceRate:88, govRegistration:{ayushmanEmpanelled:true,nhm:true,emergencyService:true,moh:false,registrationCode:"GOV-UMR-001"} },
    "HOSP-0010":{ tier:"Tier3", trustScore:91, acceptanceRate:78, govRegistration:{ayushmanEmpanelled:false,nhm:false,emergencyService:false,moh:false,registrationCode:"PVT-IDR-001"} },
    "HOSP-0011":{ tier:"Tier1", trustScore:85, acceptanceRate:96, govRegistration:{ayushmanEmpanelled:true,nhm:true,emergencyService:true,moh:true,registrationCode:"GOV-BPL-001"} },
    "HOSP-0012":{ tier:"Tier2", trustScore:82, acceptanceRate:90, govRegistration:{ayushmanEmpanelled:true,nhm:false,emergencyService:true,moh:false,registrationCode:"PVT-BPL-001"} },
    "HOSP-0013":{ tier:"Tier1", trustScore:78, acceptanceRate:94, govRegistration:{ayushmanEmpanelled:true,nhm:true,emergencyService:true,moh:true,registrationCode:"GOV-IDR-002"} },
    "HOSP-0014":{ tier:"Tier1", trustScore:74, acceptanceRate:89, govRegistration:{ayushmanEmpanelled:true,nhm:true,emergencyService:true,moh:false,registrationCode:"GOV-REW-001"} },
    "HOSP-0015":{ tier:"Tier1", trustScore:80, acceptanceRate:93, govRegistration:{ayushmanEmpanelled:true,nhm:true,emergencyService:true,moh:true,registrationCode:"GOV-GWL-001"} },
  };

  let govCount = 0;
  for (const h of hospDocs) {
    const p = govPatches[h.hospitalId];
    if (p) { 
      await Hospital.findByIdAndUpdate(h._id, p); 
      govCount++; 
    }
  }
  console.log(`✅ Gov registration applied to ${govCount} hospitals`);
